    ...
    def display_employee_data(self, emp_name):
        ...
        try:
            ...
            if not employee_object:
                ...
                print("Total employee wage for the month : {}".format(
                    employee_object.total_wage))
                print("Total days employee worked for the month : {}".format(
                    employee_object.total_emp_days))
                print("Total hours employee worked for the month : {}".format(
